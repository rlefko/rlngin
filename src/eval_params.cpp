...
static const EvalParams kDefaultEvalParams = {
    ...
    {S(0, 0), S(0, 0), S(0, 0), S(-36, -24), S(-36, -49), S(-80, -59), S(-355, -107), S(0, 0)},
    ...
    // PawnPST
    {
        ...
        S(1, 43), S(13, 44), S(29, 8), S(52, 7), S(54, 10), S(30, 7), S(12, 45), S(-3, 46),
        S(6, 34), S(12, 35), S(30, 23), S(49, 21), S(49, 20), S(30, 24), S(12, 36), S(5, 35),
        S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0)
    },
    // KnightPST (half-board)
    {
        S(-113, -25), S(-122, -7), S(-76, -15), S(-78, 14),
        S(-91, -10), S(-69, -6), S(-41, -5), S(-35, 2),
        S(-41, 2), S(-2, -1), S(12, -12), S(19, 20),
        S(-25, 12), S(29, 11), S(46, 23), S(52, 28),
    ...
    // KingPST (half-board)
    {
        ...
        S(-23, -4), S(-22, 15), S(-26, 24), S(-27, 36),
    ...
    {S(0, 0), S(-37, 33), S(-37, 33), S(-37, 71), S(9, 131), S(147, 334), S(572, 506), S(0, 0)},
    {S(0, 0), S(-5, -9), S(43, 8), S(45, 9), S(68, 20), S(68, 83), S(369, 114), S(0, 0)},
    ...
    S(10, 0), // BishopPair
    {
        ...
        {S(-2, 0), S(190, 0), S(59, 0), S(33, 0), S(29, 0), S(106, 0), S(82, 0)},
        {S(0, 0), S(119, 0), S(84, 0), S(66, 0), S(33, 0), S(81, 0), S(37, 0)}
    }, // Shelter
    {
        {S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(5, 0), S(0, 0)},
        {S(0, 0), S(0, 0), S(105, 0), S(9, 0), S(5, 0), S(0, 0), S(0, 0)},
        {S(0, 0), S(137, 0), S(326, 0), S(67, 0), S(21, 0), S(0, 0), S(0, 0)},
        {S(0, 0), S(48, 0), S(300, 0), S(69, 0), S(4, 0), S(0, 0), S(0, 0)}
    }, // UnblockedStorm
    ...
    {S(-70, -29), S(0, -31)}, // BlockedPawnPenalty (rel rank 5, 6)
