...
// time. Loss after the parallel pass cap of thirty plus twenty-four
...
static const EvalParams kDefaultEvalParams = {
    ...
    S(36, 0), // Tempo
    {S(0, 0), S(261, 256), S(1002, 656), S(1056, 602), S(1610, 927), S(2644, 2169), S(0, 0)}, // PieceScore
    // PawnPST
    {
        ...
        S(325, 163), S(-20, 238), S(137, 224), S(165, 258), S(205, 159), S(346, 194), S(-201, 287), S(-88, 236),
        S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0)
    },
    // KnightPST
    {
        S(-546, 10), S(-67, -18), S(-106, -10), S(1, -32), S(-26, -11), S(-73, -27), S(-98, -14), S(-47, -18),
        ...
        S(-521, -90), S(-362, 15), S(-383, 73), S(-85, 28), S(229, 28), S(-107, -62), S(156, -22), S(-697, 38)
    },
    // BishopPST
    {
        ...
        S(-89, 0), S(-18, 37), S(-85, -15), S(-120, 65), S(-265, 43), S(-198, -10), S(-239, 9), S(-57, -72)
    },
    // RookPST
    {
        ...
        S(-123, 28), S(55, 6), S(151, 4), S(10, 18), S(69, 20), S(-56, 30), S(-251, 60), S(79, 7)
    },
    // QueenPST
    {
        S(-97, -14), S(-42, -49), S(-26, -55), S(0, -27), S(19, -59), S(-147, -25), S(105, -227), S(-198, -15),
        S(-60, -58), S(-29, -40), S(20, -48), S(3, -17), S(19, -46), S(48, -59), S(64, -136), S(-131, -45),
        ...
        S(0, -48), S(-13, -34), S(5, 23), S(0, 34), S(22, 82), S(27, 145), S(68, 40), S(60, 34),
        S(-119, -48), S(-138, 19), S(-71, 49), S(28, 47), S(-92, 138), S(81, 9), S(-211, 122), S(126, -82),
        S(-88, 10), S(-81, 56), S(120, 1), S(35, 35), S(222, -60), S(28, 50), S(127, -37), S(13, 11)
    },
    // KingPST
    {
        S(171, -122), S(197, -74), S(136, -30), S(-90, -18), S(-29, -33), S(-139, -9), S(170, -67), S(223, -126),
        S(362, -80), S(205, -42), S(147, -12), S(89, -4), S(20, 5), S(55, -1), S(174, -29), S(249, -62),
        S(123, -54), S(62, -5), S(171, 4), S(-23, 38), S(52, 18), S(93, 11), S(191, -15), S(-8, -19),
        S(68, -30), S(115, -11), S(-75, 38), S(-45, 55), S(-82, 58), S(52, 53), S(175, 24), S(-101, 6),
        S(-202, 41), S(-4, 54), S(-41, 46), S(-200, 76), S(-224, 72), S(-79, 73), S(26, 83), S(-28, 15),
        S(120, -5), S(-185, 77), S(-407, 88), S(-396, 117), S(-327, 107), S(-91, 124), S(151, 95), S(-133, 45),
        S(326, -75), S(20, 21), S(-185, 42), S(-173, 113), S(43, 54), S(281, 63), S(18, 69), S(-124, -22),
        S(-515, -367), S(472, -86), S(66, 65), S(-132, -26), S(-215, -94), S(-250, -31), S(37, 50), S(-367, -342)
    },
    {
        {},
        {},
