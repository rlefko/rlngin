...
static const EvalParams kDefaultEvalParams = {
    ...
    {S(0, 0), S(0, 0), S(0, 0), S(-36, -24), S(-36, -49), S(-80, -60), S(-359, -108), S(0, 0)},
    ...
    // PawnPST
    {
        ...
        S(1, 43), S(13, 44), S(29, 8), S(53, 7), S(54, 10), S(30, 8), S(12, 46), S(-3, 47),
        S(6, 34), S(12, 35), S(30, 24), S(50, 21), S(49, 20), S(30, 25), S(12, 36), S(5, 35),
        S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0)
    },
    // KnightPST (half-board)
    {
        S(-113, -25), S(-122, -7), S(-76, -15), S(-77, 14),
        S(-91, -10), S(-70, -5), S(-41, -5), S(-35, 2),
    ...
    // BishopPST (half-board)
    {
        ...
        S(-24, -15), S(-34, -2), S(-4, 6), S(-9, -7),
        S(-22, 10), S(-27, 17), S(-21, 12), S(-18, 14)
    },
    // RookPST (half-board)
    {
        S(-50, -15), S(-36, -3), S(-8, -4), S(-2, -10),
        S(-68, -26), S(-41, -25), S(-16, -13), S(-31, -12),
        S(-63, -22), S(-41, -13), S(-48, -16), S(-47, -15),
    ...
    {S(0, 0), S(-37, 33), S(-37, 33), S(-37, 71), S(9, 131), S(147, 333), S(576, 506), S(0, 0)},
    ...
    S(10, 0), // BishopPair
    {
        ...
        {S(-86, 0), S(218, 0), S(116, 0), S(12, 0), S(0, 0), S(33, 0), S(119, 0)},
        {S(-2, 0), S(190, 0), S(59, 0), S(33, 0), S(29, 0), S(106, 0), S(76, 0)},
        {S(0, 0), S(119, 0), S(84, 0), S(66, 0), S(33, 0), S(84, 0), S(41, 0)}
    }, // Shelter
    {
        ...
        {S(0, 0), S(46, 0), S(300, 0), S(69, 0), S(4, 0), S(0, 0), S(0, 0)}
    }, // UnblockedStorm
