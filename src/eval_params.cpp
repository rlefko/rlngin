...
static const EvalParams kDefaultEvalParams = {
    ...
    {S(0, 0), S(0, 0), S(0, 0), S(-37, 21), S(56, 28), S(119, 28), S(119, 28), S(0, 0)},
    S(0, 25), // RookOn7thBonus
    S(0, 0), // BadBishop
    S(-1, -7), // BishopPawns
    S(48, 0), // Tempo
    {S(0, 0), S(216, 235), S(939, 583), S(970, 517), S(1489, 823), S(2689, 1864), S(0, 0)}, // PieceScore
    // PawnPST
    {
        ...
        S(-81, -37), S(-105, -50), S(-96, -73), S(-56, -71), S(-28, -81), S(-49, -71), S(-56, -61), S(-98, -59),
        S(-20, -4), S(-40, -45), S(-38, -57), S(3, -76), S(30, -75), S(-11, -67), S(-96, -27), S(-27, -27),
        S(110, 47), S(71, 61), S(102, 16), S(188, -11), S(208, -12), S(97, -4), S(46, 81), S(45, 81),
        S(231, 157), S(-18, 218), S(161, 187), S(300, 153), S(214, 148), S(18, 227), S(-249, 274), S(49, 205),
        S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0)
    },
    // KnightPST (half-board)
    {
        S(-148, -53), S(-81, -3), S(-54, -19), S(-86, 17),
        S(-94, -10), S(-94, 6), S(-21, -9), S(-13, 6),
        S(-11, 3), S(34, 3), S(35, -9), S(31, 22),
        S(2, 10), S(94, 5), S(82, 30), S(86, 26),
        S(76, 27), S(106, 0), S(134, 19), S(91, 37),
        S(-68, 9), S(72, 4), S(135, 18), S(140, 27),
        S(-61, -44), S(-8, 14), S(106, -39), S(35, 38),
        S(-297, -144), S(-147, -24), S(-80, 7), S(2, 6)
    },
    // BishopPST (half-board)
    {
        S(20, -32), S(45, -35), S(-60, 0), S(-42, 3),
        S(1, -31), S(15, -25), S(58, -10), S(-10, 8),
        S(25, -14), S(63, 6), S(13, -15), S(3, 22),
    ...
    // RookPST (half-board)
    {
        S(-35, -22), S(-35, -8), S(-6, -12), S(2, -19),
        S(-79, -26), S(-41, -35), S(-15, -28), S(-37, -19),
        S(-85, -23), S(-53, -13), S(-77, -17), S(-67, -17),
        S(-8, -12), S(-49, 6), S(-66, 18), S(22, -13),
        S(-58, 26), S(-5, 33), S(26, 15), S(30, -1),
        S(37, 8), S(-5, 28), S(51, 20), S(100, 2),
        S(23, 6), S(0, 15), S(102, -5), S(108, 4),
        S(33, 22), S(30, 26), S(45, 14), S(114, -4)
    },
    // QueenPST (half-board)
    {
        S(20, -109), S(29, -98), S(4, -71), S(26, -51),
        S(-3, -21), S(6, -41), S(49, -47), S(54, -43),
        S(-36, -24), S(42, -30), S(29, 5), S(16, -16),
        S(26, -23), S(54, 5), S(37, 14), S(23, 14),
        S(1, 5), S(29, -8), S(-5, 76), S(0, 72),
        S(24, -21), S(9, 2), S(-5, 55), S(-26, 110),
        S(-109, 10), S(-169, 79), S(-146, 112), S(-114, 120),
        S(-28, -29), S(-102, 18), S(222, -65), S(56, -10)
    },
    // KingPST (half-board)
    {
        S(234, -108), S(246, -79), S(89, -48), S(-20, -60),
        S(275, -68), S(228, -46), S(47, -13), S(-37, -7),
        S(6, -18), S(143, -23), S(34, 3), S(-66, 15),
        S(-79, 4), S(32, 16), S(-35, 43), S(-202, 45),
        S(63, 2), S(11, 53), S(-128, 68), S(-297, 80),
        S(-33, 15), S(-38, 87), S(-215, 109), S(-298, 107),
        S(263, -70), S(-102, 17), S(16, 82), S(-184, 83),
        S(-297, -239), S(300, 5), S(300, -122), S(-261, 68)
    },
    {
        {},
        {},
        {S(-68, -138), S(-39, -37), S(1, -10), S(14, 1), S(27, 17), S(35, 34), S(51, 39), S(56, 39), S(56, 39)},
        ...
        {S(-25, 259), S(6, 292), S(20, 300), S(20, 310), S(20, 311), S(20, 325), S(20, 327), S(33, 336), S(38, 337), S(45, 349), S(45, 353), S(45, 354), S(45, 357), S(45, 357), S(45, 357)},
        {S(48, 112), S(49, 266), S(93, 341), S(104, 341), S(112, 351), S(133, 351), S(141, 361), S(153, 362), S(158, 373), S(168, 377), S(168, 382), S(174, 382), S(174, 389), S(174, 398), S(176, 403), S(176, 403), S(176, 403), S(193, 403), S(193, 403), S(207, 403), S(228, 403), S(228, 403), S(228, 403), S(228, 403), S(228, 403), S(228, 403), S(240, 403), S(240, 403)},
        {},
    },
    ...
    S(11, 7), // BishopPair
    {
        ...
        {S(-20, 0), S(182, 0), S(62, 0), S(18, 0), S(49, 0), S(77, 0), S(96, 0)},
    ...
    }, // Shelter
    {
        ...
        {S(0, 0), S(0, 0), S(269, 0), S(42, 0), S(3, 0), S(6, 0), S(0, 0)}
    }, // UnblockedStorm
    {S(0, 0), S(0, 0), S(186, 0), S(13, 0), S(0, 0), S(38, 0), S(0, 0)}, // BlockedStorm
    ...
    {S(0, 0), S(0, 0), S(30, 1), S(33, 280), S(30, 1), S(30, 1), S(0, 0)}, // KingSafeCheck
    ...
    {S(-83, -23), S(-113, -95)}, // BlockedPawnPenalty (rel rank 5, 6)
